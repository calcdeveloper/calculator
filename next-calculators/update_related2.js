...
for (const file of files) {
  ...
  // The array is usually named "allSomethingTools" or "tools"
  let arrayMatch = content.match(/const (all\w+Tools) = \[/);
  if (!arrayMatch) {
    // Sometimes it's just const somethingTools = ...
    arrayMatch = content.match(/const (\w+Tools) = \[/);
    if (!arrayMatch) {
