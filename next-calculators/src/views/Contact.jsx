export default function Contact() {
    return (
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <form className="bg-calc-white p-8 rounded-xl border border-calc-lightGray shadow-sm space-y-6" action="mailto:support@calcpilot.com" method="post" encType="text/plain">
          <div>
