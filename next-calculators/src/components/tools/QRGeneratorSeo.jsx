  ...
  return (
    <article className="prose prose-slate max-w-none bg-gen-white p-10 md:p-16 rounded-[2.5rem] shadow-sm border border-gen-gray mt-12">
      ...
      <div className="p-6 bg-gen-bg/50 rounded-2xl border border-gen-gray/20">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3 text-sm font-semibold text-gen-primary p-0 m-0 list-none">
      ...
      <section id="intro" className="pt-4">
        <p className="text-lg text-gen-gray mt-0">
      ...
      <section id="definition">
        <h2 className="text-3xl font-bold text-gen-dark mb-4 tracking-tight">What is a QR Code Generator?</h2>
        <p>
      ...
      <section id="why-us">
        <h2 className="text-3xl font-bold text-gen-dark mb-4 tracking-tight">Why Use Our QR Code Generator?</h2>
        <p>
      ...
      <section id="features">
        <h2 className="text-3xl font-bold text-gen-dark mb-4 tracking-tight">Key Features</h2>
      ...
      <section id="how-to">
        <h2 className="text-3xl font-bold text-gen-dark mb-4 tracking-tight">How to Generate a QR Code</h2>
        <p>
          Building a custom asset takes only a few seconds through our intuitive four-step generation workflow:
        </p>
        <ol className="list-decimal pl-6 space-y-3 text-lg text-gen-gray">
      ...
      <section id="popular-uses">
        <h2 className="text-3xl font-bold text-gen-dark mb-4 tracking-tight">Popular Uses of QR Codes</h2>
        <p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base mt-6">
          <div className="p-6 bg-gen-bg/50 border border-gen-gray/20 rounded-2xl">
            <strong className="text-gen-dark block mb-2 text-lg">Corporate Presentation Profiles</strong>
            <p className="text-gen-gray">Add custom tracking squares to business cards, physical resumes, and portfolio assets to quickly connect prospects to your professional digital profiles.</p>
          </div>
          <div className="p-6 bg-gen-bg/50 border border-gen-gray/20 rounded-2xl">
            <strong className="text-gen-dark block mb-2 text-lg">Restaurant Menu Access</strong>
            <p className="text-gen-gray">Replace physical menus with table-side scannable cards, helping dining rooms streamline updates and lower printing costs.</p>
          </div>
          <div className="p-6 bg-gen-bg/50 border border-gen-gray/20 rounded-2xl">
            <strong className="text-gen-dark block mb-2 text-lg">Marketing Campaigns</strong>
            <p className="text-gen-gray">Place codes on promotional banners, event flyers, and print ads to instantly bridge physical audiences to high-conversion digital landing pages.</p>
          </div>
          <div className="p-6 bg-gen-bg/50 border border-gen-gray/20 rounded-2xl">
            <strong className="text-gen-dark block mb-2 text-lg">Simplified WiFi Sharing</strong>
            <p className="text-gen-gray">Encode network SSIDs and passwords into simple scannable codes, allowing office visitors and hotel guests to connect to networks instantly without manual typing.</p>
          </div>
        </div>
      </section>
      ...
      <section id="business-benefits">
        <h2 className="text-3xl font-bold text-gen-dark mb-4 tracking-tight">Benefits for Businesses (India & USA Focus)</h2>
        <p>
      ...
      <section id="individual-benefits">
        <h2 className="text-3xl font-bold text-gen-dark mb-4 tracking-tight">Benefits for Individuals</h2>
        <p>
      ...
      <section id="comparison">
        <h2 className="text-3xl font-bold text-gen-dark mb-4 tracking-tight">Why Choose Our Tool Over Others?</h2>
        <p>
      ...
      <section id="safety">
        <h2 className="text-3xl font-bold text-gen-dark mb-4 tracking-tight">Is It Safe? Local Encryption Analysis</h2>
        <p>
      ...
      <section id="tips">
        <h2 className="text-3xl font-bold text-gen-dark mb-4 tracking-tight">Tips for Better QR Codes</h2>
        <p>
          ...
          {[
            {
              ...
              a: 'No. The QR codes generated by our tool are strictly static. The raw data is encoded directly into the geometric pattern itself. As long as the destination URL or text remains active, the QR code will never expire.'
            },
            {
              q: 'How much data can a QR code actually hold?',
              a: 'A standard QR code can technically hold up to 4,296 alphanumeric characters or 7,089 numeric characters. However, the more data you encode, the denser the dot grid becomes, which can make it harder for older cameras to scan.'
            },
            {
              q: 'Can I track how many times my QR code is scanned?',
              a: 'Because our tool generates static QR codes, it does not include built-in scan tracking. To track scans, you must encode a trackable short-link (like bit.ly) or use UTM parameters in your destination URL.'
            },
            {
              q: 'Why is my generated QR code not scanning?',
              a: 'The most common reasons for scanning failures are insufficient contrast (e.g., using light colors on a white background), printing the code too small, or encoding too much text causing the grid to become too dense.'
            },
            {
              q: 'Are the QR codes generated secure and private?',
              a: 'Absolutely. The entire generation process occurs directly within your browser. We do not transmit your input text or URLs to our servers, and we do not store your generated images.'
            }
          ].map((faq, i) => (
            <details
              key={i}
