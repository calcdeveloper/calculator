export const calculateLogic = (inputs) => {
    ...
    // NEW: Generate Month-by-Month Amortization Schedule for the PDF
    let balance = P;
    let schedule = [];
    ...
    for (let month = 1; month <= n; month++) {
      ...
      // Prevent tiny floating point negatives at the end
    ...
    return {
      ...
      schedule: schedule // <-- Passing schedule to the Master Engine!
    };
  };