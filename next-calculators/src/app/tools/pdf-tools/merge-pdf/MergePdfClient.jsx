        ...
        <div className="bg-pdf-white rounded-3xl shadow-2xl border border-pdf-gray overflow-hidden p-6 md:p-8">
          ...
          {!isProcessing && !extractedUrl && (
            <div className="space-y-8">
              ...
              <div 
                className="p-12 md:p-16 flex flex-col items-center justify-center border-4 border-dashed border-pdf-gray rounded-2xl hover:bg-pdf-bg/50 transition-colors cursor-pointer"
