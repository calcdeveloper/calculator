...
export default function ColorPaletteGeneratorClient() {
  ...
  return (
    <div className="min-h-screen bg-conv-bg font-sans text-conv-dark flex flex-col">
      <section className="bg-gradient-to-r from-pink-600 to-purple-600 pt-16 pb-32 px-4 flex-shrink-0">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-conv-white/90 max-w-3xl mx-auto leading-relaxed mb-4">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 -mt-20 pb-20 flex flex-col">
        <div className="bg-conv-white rounded-3xl shadow-2xl overflow-hidden mb-8 border border-conv-gray/20 flex flex-col flex-1 min-h-[500px]">
          ...
          <div className="bg-white p-4 border-t border-conv-gray/20 flex justify-center items-center">
            <button
              onClick={generatePalette}
              className="bg-pink-600 text-white py-4 px-8 rounded-2xl font-bold hover:bg-pink-700 transition-all flex items-center justify-center gap-3 text-lg shadow-xl shadow-pink-600/30 active:scale-[0.99] w-full md:w-auto"
            >
              <RefreshCw size={20} />
      ...
      <footer className="bg-conv-white border-t border-conv-gray/30 py-8 px-6 mt-auto">
