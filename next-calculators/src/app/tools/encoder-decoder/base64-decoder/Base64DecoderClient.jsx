      ...
      <main className="max-w-6xl mx-auto px-4 -mt-20 pb-20">
        ...
        <div className="mt-8 p-6 bg-white rounded-2xl shadow-md border border-gray-100">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            <a href="/tools/encoder-decoder/base64-encoder" className="px-3 py-1.5 bg-gray-50 hover:bg-blue-50 rounded-md border text-gray-600 hover:text-blue-700 transition-colors font-medium">Base64 Encoder</a>
            ...
            <a href="/tools/developer-tools/html-formatter" className="px-3 py-1.5 bg-gray-50 hover:bg-blue-50 rounded-md border text-gray-600 hover:text-blue-700 transition-colors font-medium">HTML Formatter</a>
