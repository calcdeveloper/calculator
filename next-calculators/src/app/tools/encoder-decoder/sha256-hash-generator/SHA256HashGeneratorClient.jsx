...
import SHA256HashGeneratorSeo from "@/components/tools/SHA256HashGeneratorSeo";
      ...
      <section className="bg-gradient-to-r from-enc-primary to-enc-primaryDark pt-16 pb-32 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <nav className="flex justify-center space-x-2 text-enc-white/70 text-sm mb-6">
            <span>Tools</span> <ChevronRight size={14} /> <span>Encoder/Decoder</span> <ChevronRight size={14} /> <span className="text-white font-medium">SHA256 Hash Generator</span>
          </nav>
          ...
          <p className="text-xl text-enc-white/90 max-w-2xl mx-auto leading-relaxed">
            Instantly compute the secure 64-character cryptographic SHA-256 hash footprint of any text. Blazing fast, real-time, and processed entirely within your browser sandbox.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 gap-8">
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                placeholder="Type or paste your highly sensitive text here to instantly generate a secure SHA-256 hash..."
                className="w-full h-[200px] p-4 bg-enc-bg/50 border border-enc-gray rounded-2xl font-mono text-sm focus:ring-2 focus:ring-enc-primary focus:bg-white outline-none transition-all resize-none"
              />
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 font-bold text-enc-dark">
                  <Hash size={20} className="text-enc-primary" /> Generated SHA-256 Hash
                </label>
                <button 
                  disabled={!hash}
              ...
              <div className="relative">
                <textarea
                  readOnly
                  value={hash}
                  placeholder="64-character hexadecimal SHA-256 hash will appear here instantly..."
                  className="w-full h-[150px] p-6 bg-enc-bg/30 border border-enc-gray rounded-2xl font-mono text-xl tracking-widest leading-relaxed text-enc-primary font-bold outline-none transition-all resize-none break-all flex items-center justify-center pt-8"
                />
              </div>
            </div>
          </div>
