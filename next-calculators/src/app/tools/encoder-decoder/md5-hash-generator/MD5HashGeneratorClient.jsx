...
import MD5HashGeneratorSeo from "@/components/tools/MD5HashGeneratorSeo";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                placeholder="Type or paste your text here to instantly generate an MD5 hash..."
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 font-bold text-enc-dark">
                  <Hash size={20} className="text-enc-primary" /> Generated MD5 Hash
                </label>
                <button 
                  disabled={!hash}
              ...
              <div className="relative">
                <textarea
                  readOnly
                  value={hash}
                  placeholder="32-character hexadecimal MD5 hash will appear here instantly..."
                  className="w-full h-[300px] p-8 bg-enc-bg/30 border border-enc-gray rounded-2xl font-mono text-2xl tracking-widest leading-relaxed text-enc-primary font-bold outline-none transition-all resize-none break-all flex items-center justify-center text-center pt-28"
                />
              </div>
            </div>
          </div>
