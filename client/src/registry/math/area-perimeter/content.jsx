  ...
  return (
    <div className="space-y-10 text-gray-700 leading-relaxed mt-8 max-w-4xl mx-auto">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Free online Advanced Area and Perimeter Calculator. Calculate area, perimeter, and circumference for 8 different 2D geometric shapes easily in India."
        />
        <meta
          name="keywords"
          content="Advanced area and perimeter calculator, area calculator, perimeter calculator, calculate area of rectangle, geometry formulas"
        />
        <meta property="og:title" content="Advanced Area & Perimeter Calculator | 8 Shapes Explained" />
        <meta property="og:description" content="Calculate area, perimeter, and circumference for 8 different 2D geometric shapes with built-in unit conversions." />
      ...
      <section className="bg-gray-50 p-6 rounded-xl border border-gray-200 mt-10">
        ...
        <div className="flex flex-wrap gap-3">
          <a href="/calculator/math/algebra" className="text-sm text-blue-600 font-medium hover:underline bg-white px-3 py-1.5 rounded border border-gray-200 shadow-sm">Algebra Solver</a>
          ...
          <a href="/calculator/math/percentage-inc-dec" className="text-sm text-blue-600 font-medium hover:underline bg-white px-3 py-1.5 rounded border border-gray-200 shadow-sm">Percentage Inc/Dec</a>
