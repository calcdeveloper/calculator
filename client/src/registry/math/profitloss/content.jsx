...
export default function ProfitLossCalculatorContent() {
  ...
  return (
    <div className="space-y-10 max-w-4xl mx-auto text-gray-800 leading-relaxed mt-8">
      {/* --- SEO TAGS --- */}
      <Helmet>
        <title>Profit & Loss Calculator | Check Margins & Discounts</title>
        <meta
          name="description"
          content="Instantly calculate profit, loss, cost price, selling price, and discount margins. Free online calculator tailored for Indian business owners and students."
        />
        <meta
          name="keywords"
          content="Profit and loss calculator, discount calculator online, cost price selling price calculator, profit margin calculator india, calculate loss percentage"
        />
        <meta property="og:title" content="Profit & Loss Calculator | Check Margins & Discounts" />
        <meta property="og:description" content="Calculate your business margins instantly. Find precise profit, loss, and discount percentages with step-by-step formulas." />
