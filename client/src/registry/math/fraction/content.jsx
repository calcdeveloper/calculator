...
export default function FractionCalculatorContent() {
  ...
  return (
    <div className="space-y-10 max-w-4xl mx-auto text-gray-800 leading-relaxed mt-8">
      <Helmet>
        <title>Fraction Calculator | Add, Subtract, Simplify & Convert</title>
        <meta name="description" content="Free online Fraction Calculator for India. Easily add, subtract, multiply, divide, and simplify fractions. Instantly convert fractions to decimals step-by-step." />
