...
export default function LcmGcfCalculatorContent() {
  ...
  return (
    <div className="space-y-10 max-w-4xl mx-auto text-gray-800 leading-relaxed mt-8">
      <Helmet>
        <title>LCM & HCF Calculator Online | Find GCF & LCM Instantly</title>
        <meta name="description" content="Free online LCM and HCF calculator for India. Instantly find the Least Common Multiple and Highest Common Factor (GCF) of any numbers with step-by-step methods." />
        <meta name="keywords" content="lcm and gcf calculator, hcf and lcm calculator, online hcf calculator, least common multiple calculator, greatest common factor calculator, GCD calculator" />
