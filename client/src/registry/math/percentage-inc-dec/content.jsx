...
export default function PercentageIncreaseDecreaseContent() {
  ...
  return (
    <div className="space-y-10 max-w-4xl mx-auto text-gray-800 leading-relaxed mt-8">
      {/* --- SEO TAGS --- */}
      <Helmet>
        <title>Percentage Increase & Decrease Calculator | Find Change Fast</title>
        <meta
          name="description"
          content="Free Percentage Increase & Decrease Calculator for India. Quickly find percentage change, growth rates, and discounts with step-by-step formulas and examples."
        />
        <meta
          name="keywords"
          content="Percentage Increase & Decrease Calculator, percentage change calculator, percent increase calculator, percentage drop calculator, salary hike percentage calculator"
        />
        <meta property="og:title" content="Percentage Increase & Decrease Calculator | Find Change Fast" />
        <meta property="og:description" content="Calculate percentage growth, declines, and final values instantly. Perfect for Indian students, professionals, and shoppers." />
