...
export default function PermutationCombinationContent() {
  ...
  return (
    <div className="space-y-10 max-w-4xl mx-auto text-gray-800 leading-relaxed mt-8">
      {/* --- SEO TAGS --- */}
      <Helmet>
        <title>Permutation & Combination Calculator | Find nPr & nCr Online</title>
        <meta
          name="description"
          content="Free Permutation and Combination Calculator for India. Easily calculate nPr and nCr with or without replacement. See step-by-step formulas and results."
        />
        <meta
          name="keywords"
          content="Permutation & Combination Calculator, nPr calculator, nCr calculator online, calculate combinations, permutations with replacement, n choose r calculator"
        />
        <meta property="og:title" content="Permutation & Combination Calculator | Find nPr & nCr Online" />
        <meta property="og:description" content="Calculate permutations and combinations instantly. Perfect for Indian students, researchers, and general math use." />
