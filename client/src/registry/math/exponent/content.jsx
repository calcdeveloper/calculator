...
export default function ExponentCalculatorContent() {
  ...
  return (
    <div className="space-y-10 max-w-4xl mx-auto text-gray-800 leading-relaxed mt-8">
      <Helmet>
        <title>Exponent Calculator | Power & Indices Calculator Online</title>
        <meta name="description" content="Free Exponent Calculator for India. Easily calculate the power of numbers, decimals, and negative integers. Step-by-step solutions for students & professionals." />
        <meta name="keywords" content="Exponent calculator, power calculator, index calculator, calculate exponents online, base and exponent calculator" />
