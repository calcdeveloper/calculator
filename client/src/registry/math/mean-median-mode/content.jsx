...
export default function MeanMedianModeCalculatorContent() {
  ...
  return (
    <div className="space-y-10 max-w-4xl mx-auto text-gray-800 leading-relaxed mt-8">
      {/* --- SEO TAGS --- */}
      <Helmet>
        <title>Mean, Median, Mode & Range Calculator | Free Online Tool</title>
        <meta
          name="description"
          content="Easily calculate mean, median, mode, and range online. Free calculator for Indian students & professionals to find average, middle, most frequent values."
        />
        <meta
          name="keywords"
          content="Mean Median Mode & Range Calculator, average calculator online, find median of grouped data, mode calculation tool, statistics calculator"
        />
        <meta property="og:title" content="Mean, Median, Mode & Range Calculator | Free Online Tool" />
        <meta property="og:description" content="Easily calculate mean, median, mode, and range online. Find the average, middle, and most frequent values instantly." />
