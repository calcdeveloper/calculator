...
export default function Content() {
  ...
  return (
    <div className="space-y-10 max-w-4xl mx-auto text-gray-800 leading-relaxed mt-8">
      {/* --- SEO TAGS --- */}
      <Helmet>
        <title>Standard Deviation Calculator Online | Free Stats Tool</title>
        <meta
          name="description"
          content="Free online standard deviation and variance calculator. Instantly calculate sample and population SD, mean, and variance from your dataset step-by-step."
        />
        <meta
          name="keywords"
          content="Standard Deviation Calculator, variance calculator, population standard deviation, sample standard deviation, calculate mean online"
        />
        <meta property="og:title" content="Standard Deviation Calculator Online | Free Stats Tool" />
        <meta property="og:description" content="Calculate sample and population standard deviation, variance, and mean instantly with our free online statistics calculator." />
