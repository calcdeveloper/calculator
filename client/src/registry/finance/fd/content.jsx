...
export default function Content() {
  ...
  return (
    <div className="space-y-10 text-gray-700 leading-relaxed mt-8 max-w-4xl mx-auto">
      ...
      <Helmet>
        <title>
          FD Calculator India | Check Fixed Deposit Interest & Returns
        </title>
        <meta
          name="description"
          content="Use our free FD Calculator to instantly check your fixed deposit maturity amount and interest earned. Plan your safe investments in India accurately."
        />
        <meta
          name="keywords"
          content="FD calculator, fixed deposit calculator, FD interest rate, calculate FD returns, term deposit calculator, FD maturity calculator india, sbi fd calculator, hdfc fd returns"
        />

        {/* Suggested URL Slug: /calculator/finance/fd */}

        {/* Social Media Sharing Tags */}
        <meta
          property="og:title"
          content="Free Fixed Deposit (FD) Calculator India"
        />
        <meta
          property="og:description"
          content="Calculate your FD interest and total maturity amount instantly with quarterly compounding precision."
        />
