...
export default function Content() {
  ...
  return (
    <div className="space-y-10 text-gray-700 leading-relaxed mt-8 max-w-4xl mx-auto">
      {/* --- SEO TAGS --- */}
      <Helmet>
        <title>Free RD Calculator India | Calculate Maturity Value Online</title>
        <meta 
          name="description" 
          content="Use our free RD calculator to check your recurring deposit maturity amount and interest earned. Plan monthly savings with live quarterly compounding in India." 
        />
        <meta name="keywords" content="RD calculator, recurring deposit calculator, monthly savings calculator, RD interest calculator, post office RD calculator, calculate RD maturity, fixed return investments India" />
        
        {/* Suggested URL Slug: /calculator/finance/rd */}
        
        {/* Social Media Sharing Tags */}
        <meta property="og:title" content="Free RD Calculator | Plan Your Monthly Savings" />
        <meta property="og:description" content="Find out exactly how much your monthly bank deposits will grow into. Check your guaranteed maturity amount instantly." />
