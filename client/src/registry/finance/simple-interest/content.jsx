...
export default function Content() {
  ...
  return (
    <div className="space-y-10 text-gray-700 leading-relaxed mt-8 max-w-4xl mx-auto">
      {/* --- SEO TAGS --- */}
      <Helmet>
        <title>Free Simple Interest Calculator India | Calculate SI Online</title>
        <meta 
          name="description" 
          content="Easily calculate simple interest on your loans and investments in India. Find out your total interest and final maturity amount instantly with our free tool." 
        />
        <meta name="keywords" content="simple interest calculator, simple interest formula, calculate SI online, simple interest vs compound interest, loan interest calculator india" />
        
        {/* Suggested URL Slug: /calculator/finance/simple-interest */}
        
        {/* Social Media Sharing Tags */}
        <meta property="og:title" content="Free Simple Interest Calculator | Fast & Accurate" />
        <meta property="og:description" content="Calculate your simple interest instantly. Enter principal, rate, and time to get your total interest and final amount." />
