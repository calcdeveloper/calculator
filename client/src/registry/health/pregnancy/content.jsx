...
export default function PregnancyCalculatorContent() {
  ...
  return (
    <div className="space-y-10 text-gray-700 leading-relaxed mt-8 max-w-4xl mx-auto">
      {/* --- SEO TAGS --- */}
      <Helmet>
        <title>Accurate Pregnancy Due Date Calculator India | Track Your EDD</title>
        <meta 
          name="description" 
          content="Calculate your exact pregnancy due date using LMP, ultrasound, conception, or IVF transfer dates. Track trimester milestones with our free online calculator." 
        />
        <meta name="keywords" content="pregnancy due date calculator india, EDD calculator, calculate delivery date, pregnancy tracker online, trimester calculator, conception date calculator, IVF due date calculator" />
        
        <meta property="og:title" content="Accurate Pregnancy Due Date Calculator India | Track Your EDD" />
        <meta property="og:description" content="Calculate your exact pregnancy due date using LMP, ultrasound, conception, or IVF transfer dates. Track trimester milestones with our free online calculator." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://yourwebsite.com/pregnancy-due-date-calculator-india" />
