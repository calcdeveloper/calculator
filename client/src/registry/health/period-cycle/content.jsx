...
export default function Content() {
  ...
  return (
    <div className="space-y-10 text-gray-700 leading-relaxed mt-8 max-w-4xl mx-auto">
      {/* --- SEO TAGS --- */}
      <Helmet>
        <title>Accurate Period & Menstrual Cycle Calculator India</title>
        <meta 
          name="description" 
          content="Track your menstrual cycle, predict your next period, and calculate your exact ovulation and fertile window with our free online period calculator." 
        />
        <meta name="keywords" content="period calculator india, menstrual cycle tracker, next period calculator, safe days calculator, ovulation date calculator, period tracker online, fertile window calculator" />
        
        <meta property="og:title" content="Accurate Period & Menstrual Cycle Calculator India" />
        <meta property="og:description" content="Track your menstrual cycle, predict your next period, and calculate your exact ovulation and fertile window with our free online period calculator." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://yourwebsite.com/period-calculator-india" />
