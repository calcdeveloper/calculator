...
export default function Content() {
  ...
  return (
    <div className="space-y-10 text-gray-700 leading-relaxed mt-8 max-w-4xl mx-auto">
      {/* --- SEO TAGS --- */}
      <Helmet>
        <title>Free Body Fat Calculator | Check Body Fat Percentage</title>
        <meta 
          name="description" 
          content="Calculate your body fat percentage, lean body mass, and fat mass instantly with our free body fat calculator based on the accurate U.S. Navy Method." 
        />
        <meta name="keywords" content="body fat calculator India, body fat percentage calculator, US Navy method calculator, lean body mass calculator, check body fat online, fat mass vs lean mass, ideal body fat percentage" />
        
        {/* Suggested URL Slug: /calculator/health/body-fat */}
        
        <meta property="og:title" content="Advanced Body Fat Calculator | Fast & Accurate" />
        <meta property="og:description" content="Stop guessing your fitness progress. Find out your exact body fat percentage and lean body mass today." />
