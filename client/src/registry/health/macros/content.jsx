...
export default function Content() {
  ...
  return (
    <div className="space-y-10 text-gray-700 leading-relaxed mt-8 max-w-4xl mx-auto">
      {/* --- SEO TAGS --- */}
      <Helmet>
        <title>Free Macro Calculator India | Calculate Protein, Carbs & Fat</title>
        <meta 
          name="description" 
          content="Calculate your perfect daily macros for weight loss or muscle gain. Use our free Indian Macronutrient Calculator to find your ideal protein, carbs & fat split." 
        />
        <meta name="keywords" content="macro calculator india, calculate macros, protein carbs fat calculator, keto macro calculator, weight loss macros, bodybuilding macros, IIFYM calculator, macros for indian diet" />
        
        <meta property="og:title" content="Free Macro Calculator India | Calculate Protein, Carbs & Fat" />
        <meta property="og:description" content="Calculate your perfect daily macros for weight loss or muscle gain. Use our free Indian Macronutrient Calculator to find your ideal protein, carbs & fat split." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://yourwebsite.com/macro-calculator-india" />
